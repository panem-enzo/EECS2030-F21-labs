...
public class Unit {
	...
	public String toString() {
		...
		if (defaultUnit) {
			output = String.format("A unit of %.0f square feet (%.0f' wide and %.0f' long) functioning as %s", this.area, this.width, this.length, this.function);
		} else {
			output = String.format("A unit of %.2f square meters (%.2f m wide and %.2f m long) functioning as %s", this.area, this.width, this.length, this.function);
		}
